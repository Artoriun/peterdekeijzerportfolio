    ...
    <section className="hero">
      ...
      <div className="hero-content">
        <div className="hero-logo animate-fade-in">
          <div className="g-clef-icon animate-scale animate-stagger-1">
          ...
          <h2 className="logo-text animate-slide-up animate-stagger-2">peter de keijzer</h2>
        </div>
        <h1 className="hero-title animate-slide-up animate-stagger-3">
          <span className="gradient-text">Fullstack Developer</span>
        </h1>
        <div className="hero-visual animate-scale animate-stagger-4">
...
{`const peter = {
  ...
  passion: 'Building amazing experiences'
        ...
        <div className="hero-actions animate-slide-up animate-stagger-5">
